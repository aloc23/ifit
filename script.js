// ------- Cashflow Forecast Tool (Live Spreadsheet-Matching Logic) ---------
...
// Extract weeks from header row (row 3, columns F+)
...
// Compute rolling cash balance for each week (matches spreadsheet logic)
