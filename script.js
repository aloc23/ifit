...
function renderTable(repaymentData = null, balanceArr = null, incomeArr = null) {
  ...
  for (let rowIndex = 0; rowIndex <= balanceRowIdx; rowIndex++) {
    ...
    row.forEach((cell, cellIndex) => {
      ...
      if (rowIndex === 3 && repaymentData && repaymentData[cellIndex] > 0) {
  ...
  if (incomeArr) {
    ...
    trIncome.appendChild(document.createElement('td')); // Label cell
  ...
  if (balanceArr) {
    ...
    trBal.appendChild(document.createElement('td')); // Label cell
    trBal.appendChild(document.createElement('td'));
    trBal.appendChild(document.createElement('td'));
    trBal.appendChild(document.createElement('td'));
    trBal.appendChild(document.createElement('td'));
    weekOptions.forEach((w, i) => {
